...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Xorg_libXau_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("0c0b7dd1-d40b-584c-a123-a41640f87eec"))
...
if best_platform === nothing
    @debug("Unable to load Xorg_libXau; unsupported platform $(triplet(platform_key_abi()))")
else
